...
router.route('/api/v1/news').post(newsController_1.default.create);
...
router.route('/api/v1/news/upload').post(localUpload_1.default.single('file'), function (req, res) { return res.json({ message: 'upload file with success' }); });
